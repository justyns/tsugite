...
GOLDEN_ROUTE_TABLE = [
    ...
    ("/api/agents/{agent}/raw-messages", ("GET",), "_raw_messages"),
    ...
    ("/api/agents/{agent}/workspace/raw", ("GET",), "_read_workspace_raw"),
    ("/api/agents/{agent}/workspace/content", ("PUT",), "_save_workspace_file"),
    ("/api/agents/{agent}/workspace/attach", ("POST",), "_attach_workspace_file"),
    ("/api/agents/{agent}/hooks", ("GET",), "_get_hooks_config"),
    ("/api/agents/{agent}/hooks", ("PUT",), "_save_hooks_config"),
