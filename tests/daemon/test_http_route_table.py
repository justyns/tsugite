...
GOLDEN_ROUTE_TABLE = [
    ...
    ("/api/runtime", ("GET",), "_runtime_info"),
    ("/api/models", ("GET",), "_list_models"),
    ("/api/events", ("GET",), "_events"),
    ("/api/commands", ("GET",), "_list_commands"),
    ("/api/context-providers", ("GET",), "_list_context_providers"),
    ("/api/context-providers/{key}/choices", ("GET",), "_context_provider_choices"),
    ("/api/context-providers/{key}/search", ("GET",), "_context_provider_search"),
    ("/api/context-providers/{key}/capture", ("POST",), "_context_provider_capture"),
    ("/api/daemon/reload-config", ("POST",), "_reload_config"),
    ("/api/chat/sessions", ("GET",), "_list_sessions"),
    ("/api/chat/sessions/new", ("POST",), "_new_interactive_session"),
    ("/api/chat/sessions/{session_id}/branch", ("POST",), "_branch"),
    ("/api/chat", ("POST",), "_chat"),
    ("/api/chat/cancel", ("POST",), "_cancel_chat"),
    ("/api/chat/upload", ("POST",), "_upload"),
    ("/api/chat/status", ("GET",), "_status"),
    ("/api/chat/attachments", ("GET",), "_attachments"),
    ("/api/chat/history", ("GET",), "_history"),
    ("/api/chat/prompt-snapshot", ("GET",), "_prompt_snapshot"),
    ("/api/chat/raw-messages", ("GET",), "_raw_messages"),
    ("/api/runtime/config", ("PATCH",), "_update_runtime_config"),
    ("/api/chat/compact", ("POST",), "_compact"),
    ("/api/chat/respond", ("POST",), "_respond"),
    ("/api/chat/unload-skill", ("POST",), "_unload_skill"),
    ("/api/chat/effort-levels", ("GET",), "_effort_levels"),
    ("/api/commands/{command_name}", ("POST",), "_run_command"),
    ("/api/workspace", ("GET",), "_list_workspace_files"),
    ("/api/workspace/content", ("GET",), "_read_workspace_file"),
    ("/api/workspace/raw", ("GET",), "_read_workspace_raw"),
    ("/api/workspace/content", ("PUT",), "_save_workspace_file"),
    ("/api/workspace/attach", ("POST",), "_attach_workspace_file"),
    ("/api/hooks", ("GET",), "_get_hooks_config"),
    ("/api/hooks", ("PUT",), "_save_hooks_config"),
